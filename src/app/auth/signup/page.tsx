    ...
    <div className="font-inter text-foreground relative flex h-screen w-screen items-center justify-center">
      ...
      <div className="z-10 flex flex-col items-center px-4">
        <div className="my-8 text-center">
          <h1 className="text-primary-foreground text-lg font-medium tracking-tight">
            Mastery
          </h1>
          <p className="text-tertiary-foreground mt-1 max-w-sm text-sm">
            Create an account and unlock coding challenges and a vibrant
            community
          </p>
        </div>
        <div className="flex w-full max-w-80 flex-col items-center">
          ...
          <button className="bg-primary hover:bg-primary/90 mt-5 w-full rounded-lg px-4 py-3 font-medium text-white transition-all duration-200 hover:shadow-lg active:scale-[0.98]">
            Continue
          </button>
        ...
        <div className="mt-6 text-center">
          <p className="text-tertiary-foreground my-2 text-xs">
